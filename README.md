...
- By Using the Following command building the project and its JAR files will be completed: ./mvnw.cmd package -DskipTests
...
- Pull the Docker image from DockerHub using the following command docker pull hala1mo/hotel_management:v2
- Create a docker-compose.txt file
- Navigate to the directory containing the docker-compose.txt file.
- Run Docker Compose using the docker-compose up command, like this command: docker-compose -f Docker_Compose.txt up
